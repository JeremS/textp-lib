(ns fr.jeremyschoffen.textp.alpha.lib.build
  (:require
    ...
    [fr.jeremyschoffen.textp.alpha.lib.docs.core :as docs]
    [build :refer [token]]))
...
(def conf
  (mbt-defaults/config
    {::project/name "textp-lib"
     ::project/author "Jeremy Schoffen"
     ::project/git-url "https://github.com/JeremS/textp-lib"
